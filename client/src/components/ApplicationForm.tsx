...
export default function ApplicationForm({ onSubmit }: ApplicationFormProps) {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle className="text-2xl font-heading">Apply for Rate Clearance Certificate</CardTitle>
        <CardDescription>
          Complete the form below to apply for your Rate Clearance Certificate. All fields are required.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="63-123456X78" {...field} data-testid="input-id-number" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="+263 77 123 4567" {...field} data-testid="input-phone" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
            ...
            <div className="space-y-4">
              <h3 className="text-lg font-semibold font-heading">Property Information</h3>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="12345" {...field} data-testid="input-stand-number" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
